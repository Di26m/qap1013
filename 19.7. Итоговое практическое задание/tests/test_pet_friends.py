...
def test_add_pets_with_valid_data(name='Конь', animal_type='cat', age='3', pet_photo='images/Fedor.jpg'):
...
def test_add_pets_with_valid_data_without_photo(name='Конь', animal_type='кот', age='6'):
